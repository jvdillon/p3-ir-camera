...
For full protocol documentation, see [P3_PROTOCOL.md](P3_PROTOCOL.md).
...
- Qt GUI, multi-OS support, and UVC virtual webcam implemented by [@skywalker1905](https://github.com/skywalker1905)
